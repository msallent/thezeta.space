...
import dmConsultingLogo from '@/assets/images/dm-consulting.png';
import edConsultingLogo from '@/assets/images/ed-consulting.png';
import edenorLogo from '@/assets/images/edenor.png';
...
export const clients = [
  ...
  {
    name: 'DM Consulting',
    logo: dmConsultingLogo,
  },
  {
    name: 'ED Consulting',
    logo: edConsultingLogo,
  },
  {
    name: 'Edenor',
    logo: edenorLogo,
