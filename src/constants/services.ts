...
export const services = [
  {
    ...
    title: 'Social Media',
    description: [
      'Creamos contenido de valor, atractivo e interactivo para tus Redes Sociales, con estrategias personalizadas y resultados medibles.',
    ],
  },
  {
    title: 'Paid Media',
    Icon: Megaphone,
    description: [
      'Invertí en plataformas digitales: Meta, Google, Tiktok, Linkedin Ads. Las manejamos con precisión de expertos para maximizar resultados mientras optimizamos cada peso invertido. Acá no se desperdicia nada!',
    ],
  },
  {
    Icon: Globe,
    title: 'Diseño & Desarrollo web y apps',
    description: [
      'Creamos Sitios Web y Apps que tus usuarios no pueden dejar de usar. Trabajamos en experiencias digitales que conectan, desde el diseño hasta la funcionalidad, hacemos que todo sea intuitivo, atractivo y esté listo para vender.',
    ],
  },
  {
    Icon: Palette,
